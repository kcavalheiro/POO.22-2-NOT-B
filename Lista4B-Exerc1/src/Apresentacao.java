...
public class Apresentacao {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_6 = new JLabel("Possui conexão de internet?");
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Telefone telefone = new TelefoneResidencial(nome, endereco, data, 
												chckbxNewCheckBox.isSelected(),numero);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String ramoAtiv = textField_13.getText();

					Telefone telefone = new TelefoneComercial(nome, endereco, data, ramoAtiv,numero);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Telefone telefone = new TelefoneEspecializado(nome, endereco, data, qtdeOcorrencia, numero);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String s = "Nome usuario: " + telefone.getNome() + "\n" 
							...
							+ "Valor a pagar: R$" + telefone.getValorBasico() + "\n" 
							+ telefone.getAddInfo();  // polimorfismo para exibir os dados a mais de cada tipo de telefone
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (Telefone t : telefones.values()) {
					faturamento += t.getValorBasico(); // polimorfismo
				}
