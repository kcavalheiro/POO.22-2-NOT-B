...
class VetorDeReaisTest {
	...
	void testCaso01_DivisaoNull() {
		...
		assertNull(vetorDeReais.divide(vetorDeReais2));
	}
	...
	void testCaso02_DivisaoSucesso() {
		...
		// Act
		VetorDeReais divisaoDeReais = vetorDeReais.divide(vetorDeReais2);
		// Assert
		for (int i = 0; i < vet.length; i++) {
			assertEquals(vet[i], divisaoDeReais.getValor(i), 0.000001);
		}
	}
}
