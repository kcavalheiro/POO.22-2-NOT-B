...
public class Apresentacao {
	...
	private void initialize() {
		frmLista = new JFrame();
		frmLista.setTitle("Lista 2 - ExercÃ­cio 6");
		...
		JLabel lblNewLabel_2 = new JLabel("PosiÃ§Ã£o:");
		...
		btnPares.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frmLista, "A quantidade de pares é "+meuObjeto.getQuantidadePares());
			}
		});
